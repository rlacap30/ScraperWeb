                        ...
                        <tbody>
                           ...
                           while (
                               ...
                               $sql = "SELECT DISTINCT(Websites.Name) AS Name, Websites.CheckedDate AS Date, Parameters.Url AS Url
                                        ...
                                        WHERE Advertisements.Name = '$adname' AND Parameters.buffer_two='germany'";
                               $rows = mysqli_query($conn, $sql);
                               while ($row = mysqli_fetch_assoc($rows)) {
                                   echo "<tr>";
                                   echo "<td class='primary'><a target='_blank' href='" .
            ...
            <div class="items">
                ...
                if ($page_number >= 2) {
                    if (
                        ...
                        echo "<a href='germtest.php?adpage=" .
                            ($page_number - 1) .
                            "'>  Prev </a>";
                    }
                    ...
                    if (
                        ...
                        $filter = $_GET["filter"];
                        echo "<a href='germtest.php?filter=" .
                            $filter .
                            "&adpage=" .
                            ($page_number - 1) .
                            "'>  Prev </a>";
                    ...
                    if (
                        ...
                        $dateFromFilter = $_GET["dateFromFilter"];
                        $dateToFilter = $_GET["dateToFilter"];
                        echo "<a href='germtest.php?dateFromFilter=" .
                            $dateFromFilter .
                            "&dateToFilter=" .
                            $dateToFilter .
                            "&adpage=" .
                    ...
                    if (
                        ...
                        $dateToFilter = $_GET["dateToFilter"];
                        echo "<a href='germtest.php?dateToFilter=" .
                            $dateToFilter .
                            "&adpage=" .
                            ($page_number - 1) .
                            "'>  Prev </a>";
				...
				if ($total_pages > 10) {
				  ...
				  if ($page_number > 1) {
                    echo "<a href='germtest.php?adpage=1'> << </a>";
                    echo "<a href='germtest.php?adpage=" . ($page_number - 1) . "'> < </a>";
                  }
				  ...
				  for ($i = max(1, $page_number - 5); $i <= min($page_number + 5, $total_pages); $i++) {
				    if ($i == $page_number) {
					  ...
					  echo "<a href='germtest.php?adpage=$i'>$i</a>";
					}
				  }
				  
				  if ($page_number < $total_pages) {
				    echo "<a href='germtest.php?adpage=" . ($page_number + 1) . "'> > </a>";
					echo "<a href='germtest.php?adpage=$total_pages'> >> </a>";
				  }
				} else {
				  for ($i = 1; $i <= $total_pages; $i++) {
                    if ($i == $page_number) {
                        if (
                            ...
                            $pageURL .=
                                "<a class = 'activePage' href='germtest.php?adpage=" .
                                $i .
                                "'>" .
                                $i .
                                " </a>";
                        ...
                        if (
                            ...
                            $filter = $_GET["filter"];
                            $pageURL .=
                                "<a class = 'activePage' href='germtest.php?filter=" .
                                $filter .
                                "&adpage=" .
                                $i .
                                "'>" .
                        ...
                        if (
                            ...
                            $dateToFilter = $_GET["dateToFilter"];
                            $pageURL .=
                                "<a class = 'activePage' href='germtest.php?dateFromFilter=" .
                                $dateFromFilter .
                                "&dateToFilter=" .
                                $dateToFilter .
                                "&adpage=" .
                        ...
                        if (
                            ...
                            $dateToFilter = $_GET["dateToFilter"];
                            $pageURL .=
                                "<a class = 'activePage' href='germtest.php?dateToFilter=" .
                                $dateToFilter .
                                "&adpage=" .
                                $i .
                                "'>" .
                        ...
                        if (
                            ...
                            $dateToFilter = $_GET["dateToFilter"];
                            $pageURL .=
                                "<a href='germtest.php?dateFromFilter=" .
                                $dateFromFilter .
                                "&dateToFilter=" .
                                $dateToFilter .
                                "&adpage=" .
                        ...
                        if (
                            ...
                            $dateToFilter = $_GET["dateToFilter"];
                            $pageURL .=
                                "<a href='germtest.php?dateToFilter=" .
                                $dateToFilter .
                                "&adpage=" .
                                $i .
                                "'>" .
      ...
      function filterWesbite() {
        ...
        if (true){
            if (filter.length > 0 && dateFromInput.length > 0 && dateToInput.length > 0) {
                ...
                window.location.href = "germtest.php";
            }
        } else {
            window.location.href = "germtest.php";
        }
