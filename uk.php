                        ...
                        <tbody>
                           ...
                           while (
                               ...
                               $sql = "SELECT DISTINCT(Websites.Name) AS Name, Websites.CheckedDate AS Date, Parameters.Url AS Url
                                        ...
                                        WHERE Advertisements.Name = '$adname' AND Parameters.buffer_two='uk'";
                               $rows = mysqli_query($conn, $sql);
                               while ($row = mysqli_fetch_assoc($rows)) {
                                   echo "<tr>";
                                   echo "<td class='primary'><a target='_blank' href='" .
            ...
            <div class="items">
                ...
                if ($page_number >= 2) {
                    ...
                    if (
                        ...
                        $dateFromFilter = $_GET["dateFromFilter"];
                        $dateToFilter = $_GET["dateToFilter"];
                        echo "<a href='uk.php?dateFromFilter=" .
                            $dateFromFilter .
                            "&dateToFilter=" .
                            $dateToFilter .
                            "&adpage=" .
                    ...
                    if (
                        ...
                        $dateToFilter = $_GET["dateToFilter"];
                        echo "<a href='uk.php?dateToFilter=" .
                            $dateToFilter .
                            "&adpage=" .
                            ($page_number - 1) .
                            "'>  Prev </a>";
                ...
                if ($total_pages > 10) {
                    ...
                    for (
                        ...
                        if ($i == $page_number) {
                            ...
                            echo "<a href='uk.php?adpage=$i'>$i</a>";
                        }
                    }
                    ...
                    if ($page_number < $total_pages) {
                        echo "<a href='uk.php?adpage=" .
                            ($page_number + 1) .
                            "'> > </a>";
                        echo "<a href='uk.php?adpage=$total_pages'> >> </a>";
                    }
                } else {
                    for ($i = 1; $i <= $total_pages; $i++) {
                        if ($i == $page_number) {
                            if (
                                ...
                                $pageURL .=
                                    "<a class = 'activePage' href='uk.php?adpage=" .
                                    $i .
                                    "'>" .
                                    $i .
                                    " </a>";
                            ...
                            if (
                                ...
                                $filter = $_GET["filter"];
                                $pageURL .=
                                    "<a class = 'activePage' href='uk.php?filter=" .
                                    $filter .
                                    "&adpage=" .
                                    $i .
                                    "'>" .
                            ...
                            if (
                                ...
                                $dateToFilter = $_GET["dateToFilter"];
                                $pageURL .=
                                    "<a class = 'activePage' href='uk.php?dateFromFilter=" .
                                    $dateFromFilter .
                                    "&dateToFilter=" .
                                    $dateToFilter .
                                    "&adpage=" .
                            ...
                            if (
                                ...
                                $dateToFilter = $_GET["dateToFilter"];
                                $pageURL .=
                                    "<a class = 'activePage' href='uk.php?dateToFilter=" .
                                    $dateToFilter .
                                    "&adpage=" .
                                    $i .
                                    "'>" .
