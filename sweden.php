                        ...
                        <tbody>
                           ...
                           while (
                               ...
                               $sql = "SELECT DISTINCT(Websites.Name) AS Name, Websites.CheckedDate AS Date, Parameters.Url AS Url
                                        ...
                                        WHERE Advertisements.Name = '$adname' AND Parameters.buffer_two='sweden'";
                               $rows = mysqli_query($conn, $sql);
                               while ($row = mysqli_fetch_assoc($rows)) {
                                   echo "<tr>";
                                   echo "<td class='primary'><a target='_blank' href='" .
            ...
            <div class="items">
                ...
                if ($page_number >= 2) {
                    ...
                    if (
                        ...
                        $dateFromFilter = $_GET["dateFromFilter"];
                        $dateToFilter = $_GET["dateToFilter"];
                        echo "<a href='sweden.php?dateFromFilter=" .
                            $dateFromFilter .
                            "&dateToFilter=" .
                            $dateToFilter .
                            "&adpage=" .
                    ...
                    if (
                        ...
                        $dateToFilter = $_GET["dateToFilter"];
                        echo "<a href='sweden.php?dateToFilter=" .
                            $dateToFilter .
                            "&adpage=" .
                            ($page_number - 1) .
                            "'>  Prev </a>";
                ...
                if ($total_pages > 10) {
                    ...
                    if ($page_number > 1) {
                        echo "<a href='sweden.php?adpage=1'> << </a>";
                        echo "<a href='sweden.php?adpage=" .
                            ($page_number - 1) .
                            "'> < </a>";
                    }
                    ...
                    for (
                        ...
                        if ($i == $page_number) {
                            ...
                            echo "<a href='sweden.php?adpage=$i'>$i</a>";
                        }
                    }
                    ...
                    if ($page_number < $total_pages) {
                        echo "<a href='sweden.php?adpage=" .
                            ($page_number + 1) .
                            "'> > </a>";
                        echo "<a href='sweden.php?adpage=$total_pages'> >> </a>";
                    }
                } else {
                    for ($i = 1; $i <= $total_pages; $i++) {
                        if ($i == $page_number) {
                            if (
                                ...
                                $pageURL .=
                                    "<a class = 'activePage' href='sweden.php?adpage=" .
                                    $i .
                                    "'>" .
                                    $i .
                                    " </a>";
                            ...
                            if (
                                ...
                                $filter = $_GET["filter"];
                                $pageURL .=
                                    "<a class = 'activePage' href='sweden.php?filter=" .
                                    $filter .
                                    "&adpage=" .
                                    $i .
                                    "'>" .
                            ...
                            if (
                                ...
                                $dateToFilter = $_GET["dateToFilter"];
                                $pageURL .=
                                    "<a class = 'activePage' href='sweden.php?dateFromFilter=" .
                                    $dateFromFilter .
                                    "&dateToFilter=" .
                                    $dateToFilter .
                                    "&adpage=" .
                            ...
                            if (
                                ...
                                $dateToFilter = $_GET["dateToFilter"];
                                $pageURL .=
                                    "<a class = 'activePage' href='sweden.php?dateToFilter=" .
                                    $dateToFilter .
                                    "&adpage=" .
                                    $i .
                                    "'>" .
                            ...
                            if (
                                ...
                                $dateToFilter = $_GET["dateToFilter"];
                                $pageURL .=
                                    "<a href='sweden.php?dateFromFilter=" .
                                    $dateFromFilter .
                                    "&dateToFilter=" .
                                    $dateToFilter .
                                    "&adpage=" .
                            ...
                            if (
                                ...
                                $dateToFilter = $_GET["dateToFilter"];
                                $pageURL .=
                                    "<a href='sweden.php?dateToFilter=" .
                                    $dateToFilter .
                                    "&adpage=" .
                                    $i .
                                    "'>" .
      ...
      function filterWesbite() {
        ...
        if (true){
            if (filter.length > 0 && dateFromInput.length > 0 && dateToInput.length > 0) {
                ...
                window.location.href = "sweden.php";
            }
        } else {
            window.location.href = "sweden.php";
        }
