        ...
        <main>
          <div class="websites">
            ...
            <table id="myTable">
              ...
              <tbody id="mainData">
                ...
                while ($row = mysqli_fetch_assoc($rows)) {
                    ...
                    echo "<tr>";
                    echo "<td>" . $row["Name"] . "</td>";
                    echo "<td><a href='activateScript.php?country=switzerland&id=" .
                        $row["Wid"] .
                        "&value=" .
                        $row["IsScriptActive"] .
            ...
            <div class="items">
                ...
                if ($page_number >= 2) {
                    if (!isset($_GET["filter"])) {
                        echo "<a href='switzerlandSources.php?page=" .
                            ($page_number - 1) .
                            "'>  Prev </a>";
                    }
                ...
                if ($total_pages > 10) {
                    ...
                    if ($page_number > 1) {
                        echo "<a href='switzerlandSources.php?adpage=1'> << </a>";
                        echo "<a href='switzerlandSources.php?adpage=" .
                            ($page_number - 1) .
                            "'> < </a>";
                    }
                    ...
                    for (
                        ...
                        if ($i == $page_number) {
                            ...
                            echo "<a href='switzerlandSources.php?adpage=$i'>$i</a>";
                        }
                    }
                    ...
                    if ($page_number < $total_pages) {
                        echo "<a href='switzerlandSources.php?adpage=" .
                            ($page_number + 1) .
                            "'> > </a>";
                        echo "<a href='switzerlandSources.php?adpage=$total_pages'> >> </a>";
                    }
                } else {
                    for ($i = 1; $i <= $total_pages; $i++) {
                        if ($i == $page_number) {
                            if (!isset($_GET["filter"])) {
                                $pageURL .=
                                    "<a class = 'activePage' href='switzerlandSources.php?page=" .
                                    $i .
                                    "&filter=" .
                                    $_GET["filter"] .
                                    "'>" .
                            ...
                            if (!isset($_GET["filter"])) {
                                $pageURL .=
                                    "<a href='switzerlandSources.php?page=" .
                                    $i .
                                    "'>" .
                                    $i .
                                    " </a>";
