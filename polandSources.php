        ...
        <main>
          <div class="websites">
            ...
            <table id="myTable">
              ...
              <tbody id="mainData">
                ...
                while ($row = mysqli_fetch_assoc($rows)) {
                    ...
                    echo "<tr>";
                    echo "<td>" . $row["Name"] . "</td>";
                    echo "<td><a href='activateScript.php?country=poland&id=" .
                        $row["Wid"] .
                        "&value=" .
                        $row["IsScriptActive"] .
            ...
            <div class="items">
                ...
                if ($page_number >= 2) {
                    if (!isset($_GET["filter"])) {
                        echo "<a href='polandSources.php?page=" .
                            ($page_number - 1) .
                            "'>  Prev </a>";
                    }
                ...
                if ($total_pages > 10) {
                    ...
                    if ($page_number > 1) {
                        echo "<a href='polandSources.php?adpage=1'> << </a>";
                        echo "<a href='polandSources.php?adpage=" .
                            ($page_number - 1) .
                            "'> < </a>";
                    }
                    ...
                    for (
                        ...
                        if ($i == $page_number) {
                            ...
                            echo "<a href='polandSources.php?adpage=$i'>$i</a>";
                        }
                    }
                    ...
                    if ($page_number < $total_pages) {
                        echo "<a href='polandSources.php?adpage=" .
                            ($page_number + 1) .
                            "'> > </a>";
                        echo "<a href='polandSources.php?adpage=$total_pages'> >> </a>";
                    }
                } else {
                    for ($i = 1; $i <= $total_pages; $i++) {
                        if ($i == $page_number) {
                            if (!isset($_GET["filter"])) {
                                $pageURL .=
                                    "<a class = 'activePage' href='polandSources.php?page=" .
                                    $i .
                                    "&filter=" .
                                    $_GET["filter"] .
                                    "'>" .
